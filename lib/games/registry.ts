...
export const GAMES: GameDefinition[] = [
  ...
  },
  {
    ...
    name: "Glyph Race",
    description:
      "Rapid-fire puzzle blitz! Math, visual, reaction, and word puzzles — solve them all as fast as you can.",
    icon: "⚡",
    minPlayers: 1,
    maxPlayers: 6,
    defaultTimeLimit: 0,
    ...
    howToPlay: [
      "Solve rapid-fire puzzles: math, visual patterns, reaction, and word challenges",
      "Each puzzle has a short timer — solve it or it's skipped with a time penalty",
      "Wrong answers flash red — try again (timer keeps running)",
      "Total time across all rounds is your score — fastest wins",
      "13 different puzzle types keep you guessing!",
    ],
    difficultyDescriptions: {
      easy: "5 rounds, 15s each — simpler puzzles, relaxed pace",
      medium: "7 rounds, 10s each — harder puzzles, tighter timing",
      hard: "10 rounds, 7s each — complex puzzles, intense speed",
    },
    configOptions: [
      {
        key: "roundCount",
        ...
        default: 0,
        options: [
          { value: 0, label: "Auto (by difficulty)" },
          { value: 3, label: "3" },
          { value: 5, label: "5" },
          { value: 7, label: "7" },
          { value: 10, label: "10" },
      ...
      },
      {
        ...
        options: [
          ...
          { value: "math", label: "Math & Logic only" },
          { value: "visual", label: "Visual Pattern only" },
          { value: "reaction", label: "Reaction & Speed only" },
          { value: "word", label: "Word & Spatial only" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    description:
      "Each player sees a different piece of a magical trap. The Operator sets nodes, the Key Reader has mappings, the Validator spots decoys. Communicate verbally!",
    icon: "💣",
    minPlayers: 2,
    maxPlayers: 6,
    ...
    skillDisplay: "INT / Arcana",
    howToPlay: [
      "One player is the Operator — they control the puzzle nodes",
      "Other players have unique info: Key mappings, Validator clues, Sequence order",
      "Communicate verbally — no showing your screen!",
      "Set all nodes to the correct color (in the right order on Medium/Hard)",
      "Hit DEFUSE when ready — wrong answers cost 15 seconds!",
    ],
    difficultyDescriptions: {
      easy: "3 nodes, 1 decoy, no sequence — 5 min timer",
      medium: "4-5 nodes, 2 decoys, partial sequence — 3 min timer",
      hard: "5-6 nodes, 3-4 decoys, full sequence — 2 min timer",
    },
    configOptions: [
      {
        key: "timerDuration",
